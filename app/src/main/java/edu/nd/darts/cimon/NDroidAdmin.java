 ...
 * The primary function of CIMON is a background service, so this activity serves
 * as the main activity and entry point for the application. It provides a 3-tabbed
 * view (System activity, Sensor activity, and User activity), each providing a list 
 * view of the potential metrics for that category.  This activity may be used to 
 * observe which metrics are being actively monitored, or to enable specific metrics 
 * for testing.
 *
 * @author darts
 *
...
public class NDroidAdmin extends TabActivity {
    ...
    private BroadcastReceiver receiver =new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(level<4){
                Toast.makeText(getBaseContext(), "Changed Level"+level, Toast.LENGTH_LONG).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Toast.makeText(getBaseContext(), "This is", Toast.LENGTH_LONG).show();
...
//	    intent = new Intent().setClass(this, NDroidSystem.class);
        ...
        spec = tabHost.newTabSpec("system").setIndicator("System",
                res.getDrawable(R.drawable.icon_system))
                .setContent(intent);
        tabHost.addTab(spec);
...
//	    intent = new Intent().setClass(this, NDroidUser.class);
        ...
        spec = tabHost.newTabSpec("user").setIndicator("User Activity",
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.exit:
                ...
                if (DebugLog.DEBUG) Log.d(TAG, "CIMON service stopped - exiting");
                finish();
                return true;
            default:
